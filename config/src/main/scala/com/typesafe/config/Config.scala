...
trait Config extends ConfigMergeable {
     ...
     */
    def getNumber(path: String): java.lang.Number
     ...
     */
    // TODO(gabro): how to encode this in Scala?
     ...
     */
    @deprecated def getMilliseconds(path: String): java.lang.Long
     ...
     */
    @deprecated def getNanoseconds(path: String): java.lang.Long
     ...
     *             if value cannot be parsed as a number of the given TimeUnit
     */
    def getDuration(string: String): Duration;
     ...
     */
    def getNumberList(path: String): List[java.lang.Number]
     ...
     */
    def getIntList(path: String): List[java.lang.Integer]
     ...
     */
    def getLongList(path: String): List[java.lang.Long]
     ...
     */
    def getObjectList[O <: ConfigObject](path: String): List[O]
     ...
     */
    def getConfigList[O <: Config](path: String): List[O]
     ...
     */
    def getAnyRefList[O <: AnyRef](path: String): List[O]
     ...
     */
    def getBytesList(path: String): List[java.lang.Long]
     ...
     */
    @deprecated def getMillisecondsList(path: String): List[java.lang.Long]
     ...
     */
    @deprecated def getNanosecondsList(path: String): List[java.lang.Long]
     ...
     */
    def getDurationList(path: String, unit: TimeUnit): List[java.lang.Long];
